...
; ; Start of your code
        mul rcx                        ; assume ri*ci < 2^64-1 ; rax = r1*c1
        shl rax, 3                     ; rax = sizeof(int64_t) * r1 * c1
        mov rdx, rax
        push rdx
        ...
        mov [a1], rax                  ; current top of stack = rsp = a1 - free location on stack pointer
...
; ; TODO - Fill code for allocating the matrix into memory, you may use either the stack or heap for this purpose
; ; Start of your code
        mul rcx                        ; assume ri*ci < 2^64-1 ; rax = r2*c2 & (2^64-1) => rax = r2*c2
        shl rax, 3                     ; rax = sizeof(int64_t) * r2 * c2
        mov rdx, rax
        push rdx
        ...
        mov [a2], rax                  ; current top of stack = rsp = a1 - free location on stack pointer
...
; ; Start of your code
        mul rcx                        ; rax = r3*c3
        shl rax, 3                     ; rax = sizeof(int64_t) * r3 * c3
        mov rdx, rax
        push rdx
        ...
        mov [a3], rax                  ; current top of stack = rsp = a1 - free location on stack pointer
